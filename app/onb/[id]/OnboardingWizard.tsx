...
import { steps, type SectionKey } from "@/lib/onboarding-form-config";
import FileUploadField from "./FileUploadField";

const UPLOADABLE_KEYS = new Set(["logoLink", "logosLink", "fotosLink"]);
              ...
              if (UPLOADABLE_KEYS.has(f.key)) {
                return (
                  <FileUploadField
                    ...
                    onChange={(v) => updateField(current.section, f.key, v)}
                  />
                );
              }
              return (
