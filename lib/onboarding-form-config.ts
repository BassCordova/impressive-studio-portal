...
export const steps: StepConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "diferenciadorCompetitivo", label: "Completa la frase: “Somos los únicos que…”", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "kpisImportantes", label: "¿Cómo sabrás que esto funcionó? (ej: más citas agendadas, más ventas por WhatsApp)", type: "textarea" },
      { key: "metricaConversion", label: "¿Qué cuenta como “una venta / un éxito”? (ej: agendó, pidió el link de pago, dejó sus datos)", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "arquetipo", label: "Arquetipo de marca (ej: el Héroe, el Sabio, el Amigo, el Rebelde...)", type: "text" },
      { key: "personalidadMarca", label: "Si tu marca fuera una persona, ¿cómo sería? (3-5 adjetivos)", type: "text" },
      { key: "tagline", label: "Tagline / eslogan (si tienes)", type: "text" },
      { key: "mensajesClave", label: "Mensajes clave que la marca siempre quiere transmitir", type: "textarea" },
      { key: "historiaOrigen", label: "Historia de origen (por qué nació la marca)", type: "textarea" },
      { key: "pruebaSocial", label: "Prueba social: casos, testimonios, cifras o logros para mostrar", type: "textarea" },
      { key: "tonoDeVoz", label: "Tono de voz (formal, cercano, divertido...) — y escribe cómo saludarías a un cliente", type: "textarea" },
      ...
      { key: "ejemploFraseSi", label: "Ejemplo de una frase que tu marca SÍ diría", type: "textarea" },
      { key: "ejemploFraseNo", label: "Ejemplo de una frase que tu marca NUNCA diría", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "objecionesComunes", label: "Objeciones comunes de clientes (y cómo las responden hoy)", type: "textarea" },
      ...
      { key: "idiomasAtencion", label: "¿En qué idioma(s) debe atender el agente?", type: "text" },
      { key: "horarioAtencion", label: "Horario de atención", type: "text" },
    ],
  },
  {
